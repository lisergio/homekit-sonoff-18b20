...
var options = {
  port: 1883,
  host: '192.168.0.56',
  clientId: 'Temperatura18b20'
};
var client = mqtt.connect(options);
console.log("Temperature18b20 Sensor Connected to MQTT broker");
client.subscribe('Temperatura18b20');
...
var sensor = exports.accessory = new Accessory('Sensor Temperatura 18b20', sensorUUID);

// Add properties for publishing (in case we're using Core.js and not BridgedCore.js)
sensor.username = "C9:0D:9C:AF:CE:EA";
